...
$('.clients-logo-carousel').slick({
  ...
  // Course Slider Index
  var isMobile = window.innerWidth < 992; // Define the breakpoint for mobile screens (adjust as needed)

  $('.course-group-slider').slick({
    dots: true,
    arrows: true,
    autoplay: isMobile, // Enable autoplay on mobile, disable on desktop
    autoplaySpeed: 2500, // Set the autoplay speed for mobile
    // centerPadding: '20px',
    slidesToShow: 4,
    slidesToScroll: 1,
    responsive: [
